...
export default function EmailSentPage({
  ...
  return (
    <div className="min-h-screen pt-14 w-full bg-[url('/images/fruit-platter-002.webp')] bg-no-repeat bg-cover bg-center bg-fixed flex flex-col justify-center items-center">
