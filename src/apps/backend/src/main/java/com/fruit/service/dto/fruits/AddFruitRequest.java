...
public record AddFruitRequest(
        ...
        @Schema(description = "Initial quantity available for this batch", example = "100") @NotNull(message = "Initial stock is required") @Min(value = 0, message = "Stock cannot be negative") Integer initialStock,
