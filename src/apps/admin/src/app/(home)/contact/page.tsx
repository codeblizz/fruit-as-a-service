...
const ContactMethod = ({ icon: Icon, title, description, action }: any) => (
  <div className="flex gap-4 p-6 rounded-2xl bg-white border border-stone-100 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-900/5 transition-all group">
    ...
    <div>
      ...
      <p className="text-sm text-stone-500 mb-2 leading-relaxed">{description}</p>
    ...
    return (
      <div className="min-h-screen bg-stone-50 flex items-center justify-center px-6">
        <div className="max-w-md w-full bg-white p-10 rounded-[2.5rem] shadow-xl text-center">
          ...
          <h2 className="text-3xl font-serif font-medium text-stone-900 mb-4">Message Planted!</h2>
          <p className="text-stone-600 mb-8 leading-relaxed">
            We've received your inquiry. One of our orchard specialists will sprout a response in your inbox within 24 hours.
          </p>
          <button 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-serif font-medium text-stone-900 tracking-tight leading-tight mb-6">
              Let's grow something <span className="italic text-emerald-700">great</span> together.
            </h1>
            <p className="text-stone-600 text-lg leading-relaxed">
              Whether you're a local grower looking to join our network, or a customer with a question about your harvest, our team is ready to help.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7">
              <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-sm border border-stone-100 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-stone-700 ml-1">Your Message</label>
                    <textarea 
                      required
                      rows={5}
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="px-8 flex items-center gap-6">
                <span className="text-xs font-bold text-stone-400 uppercase tracking-widest">Follow us</span>
                <div className="h-px flex-grow bg-stone-200"></div>
                <div className="flex gap-4">
                  {['Instagram', 'Twitter', 'LinkedIn'].map(social => (
                    <button key={social} className="text-sm font-medium text-stone-600 hover:text-emerald-700 transition-colors">
                      {social}
                    </button>
                  ))}
                </div>
