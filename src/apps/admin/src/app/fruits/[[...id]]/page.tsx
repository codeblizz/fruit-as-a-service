...
import FruitDashboard from "@/packages/ui/src/organisms/fruits/fruitDashboard";
...
async function Fruits() {
  return (
    <Fragment className="min-h-screen relative grid grid-cols-4">
      ...
      />
      <FruitDashboard className="col-span-3 absolute left-[20%] w-[80%] h-[100%] overflow-auto bg-[url('/images/fruit-platter-002.webp')] bg-fixed bg-no-repeat bg-cover bg-center" />
    </Fragment>
  );
}
