...
function FruitMainDashboard({ className }: { className: string }) {
  ...
  const { fruitCategories, fruits } = useFruit<FruitFormInput, ZodSchema>(CONSTANT.defaultFruitValues, FruitSchema);
