...
export default function AddFruitCategory() {
  ...
  return (
    <Section className="min-h-screen bg-ghost-apple flex flex-col items-start justify-start">
      <FruitBreadCrumb className="mb-10" />
      <Section className="flex gap-6 w-full items-start justify-center mb-16">
        ...
        <FruitHeader
          ...
          message="Add your new seasonal fruit category, adjust market pricing, and
