...
const FAQItem = ({ question, answer, isOpen, onClick }: any) => (
  <div className="border-b border-stone-200">
    ...
    >
      <span className="text-lg font-medium text-stone-900 leading-tight">{question}</span>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <div className="relative max-w-xl mx-auto">
              ...
              <input 
                ...
                className="w-full pl-12 pr-6 py-4 bg-white border border-stone-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            <CategoryCard 
              ...
              onClick={() => { setActiveCategory('Delivery'); setOpenIndex(0); }} 
            />
            <CategoryCard 
              icon={RefreshCcw} 
              label="Refunds" 
              isActive={activeCategory === 'Refunds'} 
              onClick={() => { setActiveCategory('Refunds'); setOpenIndex(0); }} 
            />
            <CategoryCard 
              icon={ShoppingBag} 
              label="Bulk Orders" 
              isActive={activeCategory === 'Bulk Orders'} 
              onClick={() => { setActiveCategory('Bulk Orders'); setOpenIndex(0); }} 
            />
          </div>
          ...
          <div className="mt-20 bg-emerald-900 rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-100/70 mb-10 max-w-lg mx-auto leading-relaxed">
                Our support team is available 7 days a week to help with your harvest inquiries.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-emerald-900 px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-emerald-50 transition-all">
                  <MessageCircle size={18} />
                  Live Chat Now
                </button>
                <button className="bg-transparent border border-white/20 text-white px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-white/10 transition-all">
                  Contact Support
                  <ArrowRight size={18} />
                </button>
              </div>
